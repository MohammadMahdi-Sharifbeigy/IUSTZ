...
```bash
git clone <https://github.com/MohammadMahdi-Sharifbeigy/IUSTZ>
cd <IUSTZ>
```
...
This command will compile the project.
 ...
 To run the compiled executable, you will use different commands depending on your operating system. Here’s how you can do it:
...
For macOS and Linux, you would use:

```bash
./game
```

Just type the command into your terminal or command prompt and press Enter to execute the compiled program. Remember, there’s no need for the ./ prefix on Windows.
