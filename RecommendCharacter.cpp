...
void recommendCharacter() {
  ...
  if (maxindex == 0) {
    ...
    cout << "We recommend you to choose <Assasin> as your character based on "
            "your personality!"
         << endl;
    cout << "But you are free to choose any character you want!" << endl;
  } else if (maxindex == 2) {
    cout << "We recommend you to choose <SuperHero> as your character based on "
            "your personality!"
         << endl;
    cout << "But you are free to choose any character you want!" << endl;
  } else if (maxindex == 3) {
    ...
    cout << "We recommend you to choose <Asian Mom> as your character based on "
            "your personality!"
         << endl;
    cout << "But you are free to choose any character you want!" << endl;
  }
